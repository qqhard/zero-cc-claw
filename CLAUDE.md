...
| Supervisor | Heart monitor | This project (~180 lines) |
...
├── supervisor/             # Supervisor bot (~180 lines)
├── template/               # Bot CLAUDE.md template
├── .claude/skills/         # Built-in skills (heartbeat)
...
- Keep supervisor under 200 lines. If it grows, something belongs in CLAUDE.md instead.
